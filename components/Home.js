    ...
    render(){
        ...
        return (
                 ...
                 <View style={styles.container}><StatusBar style="light" />
                   ...
                   <ScrollView>
                    <View style={{marginLeft:25,marginRight:25,marginTop:60,borderRadius:15,borderWidth:1,flexDirection:'row',paddingBottom:10,paddingTop:10,backgroundColor:'white'}}>
                    ...
                    <View style={{marginLeft:25,marginRight:25,marginTop:30,borderRadius:15,borderWidth:1,flexDirection:'row',paddingBottom:10,paddingTop:10,backgroundColor:'white'}}>
                        <View style={{width:width * 0.4,justifyContent:'center',alignItems:'center'}}>
                          <Text style={{fontSize:14,fontWeight:'bold'}}>BREAD/BAKERY</Text>
                        </View>
                        <View style={{width:width * 0.6}}>
                          <TouchableOpacity onPress={() => navigation.navigate('Createshop')}>
                            <Image source={require('./../assets/images/bread.jpg')} style={{height:90,width:130,borderRadius:10,marginLeft:20}}></Image> 
                          </TouchableOpacity>
                    ...
                    <View style={{marginLeft:25,marginRight:25,marginTop:30,borderRadius:15,borderWidth:1,flexDirection:'row',paddingBottom:10,paddingTop:10,backgroundColor:'white'}}>
                        <View style={{width:width * 0.4,justifyContent:'center',alignItems:'center'}}>
                          <Text style={{fontSize:14,fontWeight:'bold'}}>BEVERAGES</Text>
                        </View>
                        <View style={{width:width * 0.6}}>
                          <TouchableOpacity onPress={() => navigation.navigate('Grocery')}>
                            <Image source={require('./../assets/images/bev.jpg')} style={{height:90,width:130,borderRadius:10,marginLeft:20}}></Image> 
                          </TouchableOpacity>
